...
#==================================================================================
# T versus R plots
figTVSR = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax2 = plt.axes()
...
plt.ylabel(r'Density $\rho$ ($g/cm^3$)',fontsize=axis_size)
plt.legend(('Vargaftik 6MPa','Vargaftik 12MPa','Vargaftik 16MPa','Vargaftik 30MPa','Angus 50MPa','Angus 65MPa'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figTVSR.savefig('./'+output_folder+r'\pure_CO2_density_isobar_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
# R versus T coexistence plots.
figRVSTcoex = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax3 = plt.axes()
...
plt.xlabel('Temperature T (K)',fontsize=axis_size)
plt.ylabel(r'Density $\rho$ ($g/cm^3$)',fontsize=axis_size)
plt.legend(('Newitt Gas','Angus Gas','Duschek Gas','Newitt Liquid','Angus Liquid','Duschek Liquid'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figRVSTcoex.savefig('./'+output_folder+r'\pure_CO2_density_TR_coexistence_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
# R versus P coexistence plots.
figRVSP = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax4 = plt.axes()
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figRVSP.savefig('./'+output_folder+r'\pure_CO2_density_PR_coexistence_'+param_set+img_extension,dpi=img_dpi)
...
for i in range(0,len(T0_Coex_Newitt)):
	T_Newitt_Inv[i] = 1/T0_Coex_Newitt[i]
...
for i in range(0,len(T0_Coex_Angus)):
	T_Angus_Inv[i] = 1/T0_Coex_Angus[i]
...
for i in range(0,len(T0_Coex_Duschek)):
	T_Duschek_Inv[i] = 1/T0_Coex_Duschek[i]
...
# for i in range(0,len(T0_Theory)):
	# T_Theory_Inv[i] = 1/T0_Theory[i]
	# P_Theory_Inv[i] = math.log(P0_Theory[i])
figVAPINV = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax5 = plt.axes()
...
plt.xlabel(r'$1/T$ ($K^{-1}$)',fontsize=axis_size)
plt.ylabel(r'log$(P/P_0)$',fontsize=axis_size)
plt.legend(('Newitt Gas','Angus Gas','Duschek Gas'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
#plt.axis([0,8,0,1.2])
minorLocator = AutoMinorLocator()
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figVAPINV.savefig('./'+output_folder+r'\pure_CO2_vapour_pressure_inversion_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
# Thermal expansivity plots.
figTHREXP = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax6 = plt.axes()
...
plt.xlabel('Temperature T (K)',fontsize=axis_size)
plt.ylabel(r'Thermal expansivity $\alpha$ ($K^{-1}$)',fontsize=axis_size)
plt.legend(('Vargaftik 16MPa','Vargaftik 30MPa','Angus 50MPa','Angus 65MPa'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figTHREXP.savefig('./'+output_folder+r'\pure_CO2_thermal_expansivity_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
#Isothermal compressibility plots.
figTHRCOMP = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax7 = plt.axes()
...
plt.xlabel('Pressure P (MPa)',fontsize=axis_size)
plt.ylabel(r'Isothermal compressibility $\beta$ ($MPa^{-1}$)',fontsize=axis_size)
plt.legend(('Xiong 380K','Angus 380K','Angus 430K','Angus 490K','Angus 660K','Angus 1100K'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
plt.axis([0,68,0,0.4])
minorLocator = AutoMinorLocator()
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figTHRCOMP.savefig('./'+output_folder+r'\pure_CO2_isothermal_compressibility_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
# Isochoric heat capacity plots.
figCHRCAP = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax8 = plt.axes()
plt.plot(T0_CV1,CV_CV1,'.r')
plt.plot(T0_CV2,CV_CV2,'.g')
plt.plot(T0_CV3,CV_CV3,'.b')
plt.plot(T0_CV1,R55_CV,'r')
plt.plot(T0_CV2,R1023_CV,'g')
plt.plot(T0_CV3,R792_CV,'b')
plt.xlabel('Temperature T (K)',fontsize=axis_size)
plt.ylabel(r'Isochoric heat capacity $C_V$ ($J K^{-1} g^{-1}$)',fontsize=axis_size)
plt.legend(('Angus 0.055 g/cm^3','Angus 0.792 g/cm^3','Angus 1.023 g/cm^3'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figCHRCAP.savefig('./'+output_folder+r'\pure_CO2_isochoric_heat_capacity_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
# Isobaric heat capacity plots.
figBARCAP = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax9 = plt.axes()
plt.plot(T0_50MPa,CP_50MPa,'.r')
plt.plot(T0_65MPa,CP_65MPa,'.g')
plt.plot(P50MPa_T,P50MPa_CP,'r')
plt.plot(P65MPa_T,P65MPa_CP,'g')
plt.xlabel('Temperature T (K)',fontsize=axis_size)
plt.ylabel(r'Isobaric heat capacity $C_P$ ($J K^{-1} g^{-1}$)',fontsize=axis_size)
plt.legend(('Angus 50MPa','Angus 65MPa'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
plt.axis([0,1200,0,1.8])
minorLocator = AutoMinorLocator()
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figBARCAP.savefig('./'+output_folder+r'\pure_CO2_isobaric_heat_capacity_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
# H_vap versus T coexistence plots.
figHVAP = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax10 = plt.axes()
plt.plot(T0_Coex_Newitt,H0_Coex_Newitt,'^r')
plt.plot(T0_Coex_Angus,H0_Coex_Angus,'og')
# plt.plot(T0_Theory,H_vap,'b')
plt.xlabel('Temperature T (K)',fontsize=axis_size)
plt.ylabel(r'Enthalpy of vapourization $\Delta H_{vap}$ ($J g^{-1}$)',fontsize=axis_size)
plt.legend(('Newitt','Angus'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
#plt.axis([216.15,310,0,1.2])
minorLocator = AutoMinorLocator()
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figHVAP.savefig('./'+output_folder+r'\pure_CO2_enthalpy_vapourization_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
# Second virial coefficient along zero pressure isobar plot.
figVIRIAL = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax11 = plt.axes()
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figVIRIAL.savefig('./'+output_folder+r'\pure_CO2_second_virial_coefficient_'+param_set+img_extension,dpi=img_dpi)

#==================================================================================
#Relative deviation versus P plots.
figPDEV = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax = plt.axes()
#plt.plot(P_dev_D,deviation_L_D,'xb')
#plt.plot(P_dev_D,deviation_G_D,'p',color='salmon')
#plt.plot(P0_323,Self_deviation_323,'-og')
plt.plot(P0_373,Self_deviation_373,'-og')
plt.plot(P0_380,Self_deviation_380,'-^r')
#plt.plot(P0_400,Self_deviation_400,'-vm')
plt.plot(P0_420,Self_deviation_420,'-*b')
#plt.plot(P0_490,Self_deviation_490,'-dk')
plt.plot(P0_660,Self_deviation_660,'->',color='orange')
plt.plot(P0_1100,Self_deviation_1100,'-<',color='gray')
#plt.plot(P0_323,Kilpatrick_deviation_323,'-.og')
plt.plot(P0_373,Kilpatrick_deviation_373,'-.og')
plt.plot(P0_380,Kilpatrick_deviation_380,'-.^r')
#plt.plot(P0_400,Kilpatrick_deviation_400,'--vm')
plt.plot(P0_420,Kilpatrick_deviation_420,'-.*b')
#plt.plot(P0_490,Kilpatrick_deviation_490,'--dk')
plt.plot(P0_660,Kilpatrick_deviation_660,'-.>',color='orange')
plt.plot(P0_1100,Kilpatrick_deviation_1100,'-.<',color='gray')
#plt.plot(npy.linspace(0,68,10),npy.linspace(0,0,10),'--k')
plt.xlabel(r'Pressure P ($MPa$)',fontsize=axis_size)
plt.ylabel(r'Relative density deviation (%)',fontsize=axis_size)
#plt.legend(('Garg 323K','Garg 373K','Xiong 380K','Xiong 400K','Xiong 420K','Angus 490K','Angus 660K','Angus 1100K'),loc=1,fontsize=size,numpoints=1)
plt.legend(('Garg 373K','Xiong 380K','Xiong 420K','Angus 660K','Angus 1100K'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
plt.axis([0,68,0,25])
minorLocator = AutoMinorLocator()
ax.xaxis.set_minor_locator(minorLocator)
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figPDEV.savefig('./'+output_folder+r'\pure_CO2_pressure_relative_deviation'+img_extension,dpi=img_dpi)

#==================================================================================
#Relative deviation versus T plots.
figTDEV = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax = plt.axes()
#plt.plot(T0_6MPa,Self_deviation_6MPa,'-og')
plt.plot(T0_12MPa,Self_deviation_12MPa,'-og')
plt.plot(T0_16MPa,Self_deviation_16MPa,'-^r')
plt.plot(T0_30MPa,Self_deviation_30MPa,'-vm')
#plt.plot(T0_50MPa,Self_deviation_50MPa,'-*y')
plt.plot(T0_65MPa,Self_deviation_65MPa,'-xb')
#plt.plot(T0_6MPa,Kilpatrick_deviation_6MPa,'-.og')
plt.plot(T0_12MPa,Kilpatrick_deviation_12MPa,'-.og')
plt.plot(T0_16MPa,Kilpatrick_deviation_16MPa,'-.^r')
plt.plot(T0_30MPa,Kilpatrick_deviation_30MPa,'-.vm')
#plt.plot(T0_50MPa,Kilpatrick_deviation_50MPa,'--*y')
plt.plot(T0_65MPa,Kilpatrick_deviation_65MPa,'-.xb')
plt.xlabel(r'Temperature T ($K$)',fontsize=axis_size)
plt.ylabel(r'Relative density deviation (%)',fontsize=axis_size)
#plt.legend(('Vargaftik 6MPa','Vargaftik 12MPa','Vargaftik 16MPa','Vargaftik 30MPa','Angus 50MPa','Angus 65MPa'),loc=1,fontsize=size,numpoints=1)
plt.legend(('Vargaftik 12MPa','Vargaftik 16MPa','Vargaftik 30MPa','Angus 65MPa'),loc=1,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
#plt.axis([0,68,0,25])
minorLocator = AutoMinorLocator()
ax.xaxis.set_minor_locator(minorLocator)
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figTDEV.savefig('./'+output_folder+r'\pure_CO2_temperature_relative_deviation'+img_extension,dpi=img_dpi)

#==================================================================================
#Relative deviation at single temperature plot.
figTREL2 = plt.figure(num=None, figsize=(12, 10), dpi=img_dpi, facecolor='w', edgecolor='k')
ax = plt.axes()
...
plt.xlabel(r'Pressure P ($MPa$)',fontsize=axis_size)
plt.ylabel(r'Relative density deviation (%)',fontsize=axis_size)
plt.legend(('Kilpatrick','Kiszka','Pope','Wang','Hariharan','Garg','Xiong','Doghieri','Nalawade','Funami','Cao','Arce','Present work'),loc=2,fontsize=size,numpoints=1)
#plt.title(title,fontsize=title_size)
#plt.axis([0,68,0,25])
minorLocator = AutoMinorLocator()
ax.xaxis.set_minor_locator(minorLocator)
...
plt.tick_params(which='major', length=7)
plt.tick_params(which='minor', length=4)
figTREL2.savefig('./'+output_folder+r'\pure_CO2_temperature_relative_deviation_single'+img_extension,dpi=img_dpi)
